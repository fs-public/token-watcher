...
export const RPC_ENDPOINT_HTTP = "https://mainnet.infura.io/v3/" + process.env.REACT_APP_INFURA_API_KEY
console.log(RPC_ENDPOINT_HTTP)
//"https://rpc.ankr.com/eth";

export const RPC_ENDPOINT_WSS = "wss://mainnet.infura.io/ws/v3/" + process.env.REACT_APP_INFURA_API_KEY
